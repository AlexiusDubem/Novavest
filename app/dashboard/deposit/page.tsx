...
// Official BOLDWAVE funding wallet addresses
  ...
  async function handleExpectedDeposit() {
    ...
    try {
      ...
      await fireAlert({
        ...
        text: `BOLDWAVE has been notified of your ${cryptoAmount} ${selectedAsset.symbol} transfer (${formatCurrency(usdValue)}). Please send the funds if you haven't already.`,
        icon: 'success',
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-2xl text-base font-medium text-slate-500 leading-relaxed">
            Choose a live mandate channel, fulfill the transfer, and notify the BOLDWAVE treasury for confirmation.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[0.7fr_1.3fr]">
        <Card className="dashboard-card overflow-hidden border-slate-200/60 bg-white rounded-[32px] p-0">
          <CardHeader className="p-6 pb-2">
            ...
            <CardDescription className="text-xs font-medium text-slate-400 uppercase tracking-widest">BOLDWAVE Treasury Gateways</CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6 p-6 pt-4 sm:p-8">
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <p className="text-xs font-medium text-slate-400">Input the exact volume of {selectedAsset?.symbol} dispatched. BOLDWAVE calculates high-water mark conversion in real-time.</p>
              </div>
