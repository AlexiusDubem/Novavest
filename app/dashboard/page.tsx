...
const actions = [
  ...
  { label: 'Withdraw', icon: faCreditCard, href: '/dashboard/withdraw', description: 'Send a live withdrawal request for NovaVest confirmation.' },
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div className="space-y-2">
          ...
          <h1 className="text-3xl font-black tracking-tighter text-slate-950 sm:text-5xl">NovaVest Terminal</h1>
          <p className="max-w-xl text-sm font-bold text-slate-500 leading-relaxed sm:text-base">
            Welcome, {profile?.firstName}. Your workspace is synchronized with the NovaVest institutional grid.
          </p>
        </div>
