      ...
      <main className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-foreground mb-4">How BOLDWAVE Works</h1>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Get started with BOLDWAVE in just 5 simple steps. From signup to growth, we've made investing straightforward and secure.
            </p>
          </div>
          ...
          <div className="text-center mt-16">
            <div className="bg-card border border-border rounded-lg p-8 max-w-2xl mx-auto">
              ...
              <p className="text-muted-foreground mb-6">
                Join thousands of investors who have already illuminated their financial future with BOLDWAVE.
              </p>
