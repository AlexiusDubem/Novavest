            ...
            <div className="flex-1 overflow-y-auto">
              ...
              <div className="border-b border-slate-100 bg-slate-50/80 px-5 py-4">
                ...
                <div className="flex flex-col gap-2">
                  <a href="https://wa.me/12135851753" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2.5 text-sm font-bold text-slate-700 hover:text-teal-600 transition-colors">
