...
const PIN_STORAGE_KEY = 'novainvest-dashboard-pin'
const SESSION_UNLOCK_KEY = 'novainvest-dashboard-unlocked'
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/95 p-4">
      <div className="w-full max-w-md rounded-[2rem] border border-slate-700 bg-slate-900/95 p-8 text-white shadow-2xl shadow-black/40">
        <h2 className="text-3xl font-semibold">NovaInvest Secure Lock</h2>
